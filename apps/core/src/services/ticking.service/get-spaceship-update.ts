...
import type { Impact, Motion, WorldSnapshot } from './types';
...
function getBodyPositions(world: WorldSnapshot, time: Date) {
...
function getBodyVelocity(world: WorldSnapshot, bodyName: string, time: Date) {
